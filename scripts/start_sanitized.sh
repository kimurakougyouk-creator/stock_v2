...
run_isolated() {
  /usr/bin/env -i \
    ...
    AI_ASSET_ENABLE_IBKR_PAPER="${AI_ASSET_ENABLE_IBKR_PAPER:-}" \
    AI_ASSET_ENABLE_LIVE_TRADING="${AI_ASSET_ENABLE_LIVE_TRADING:-}" \
    AI_ASSET_LIVE_TRADING_UNLOCKED="${AI_ASSET_LIVE_TRADING_UNLOCKED:-}" \
    IBKR_PAPER_MONITOR_EMAIL_ALERTS="${IBKR_PAPER_MONITOR_EMAIL_ALERTS:-}" \
    IBKR_PAPER_MONITOR_EMAIL_COOLDOWN_HOURS="${IBKR_PAPER_MONITOR_EMAIL_COOLDOWN_HOURS:-}" \
    IBKR_PAPER_MONITOR_MAX_RUNTIME_AGE_HOURS="${IBKR_PAPER_MONITOR_MAX_RUNTIME_AGE_HOURS:-}" \
    IBKR_PAPER_MONITOR_MAX_HISTORY_BYTES="${IBKR_PAPER_MONITOR_MAX_HISTORY_BYTES:-}" \
