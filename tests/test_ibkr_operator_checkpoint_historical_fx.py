...
def _fx():
    return SimpleNamespace(
        ...
        exchange="IDEALPRO", bid=None, ask=None, rate=150.0,
        source="HISTORICAL_MIDPOINT", order_sent=False, errors=("10197",), ready=True,
    )
...
def _accounting():
    return SimpleNamespace(
        account_currency="JPY", confirmed_fill_count=0, equity_point_count=0,
        ending_equity=1000000.0, realized_pnl=0.0, unrealized_pnl=0.0,
...
def _preflight():
    return SimpleNamespace(
        allowed=True, reason="passed", planned_notional_account=114000.0,
