...
def main() -> int:
    ...
    if result.risk is not None:
        ...
        print("POSITION COUNT        : UNAVAILABLE")
        print("DAILY BUY/SELL COUNT  : UNAVAILABLE")
        print("DAILY TRADING AMOUNT  : UNAVAILABLE")
        print("DAILY REALIZED PNL    : UNAVAILABLE")
        print("CONSECUTIVE LOSSES    : UNAVAILABLE")
